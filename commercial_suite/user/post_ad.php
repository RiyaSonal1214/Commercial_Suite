            ...
            <div class="col-lg-5 card bg-info" style="margin-bottom: 10px;margin-top: 10px;">
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="adtitle" placeholder="ENTER AD TITLE" pattern="[A-Za-z\s]+" required="">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="adcontent" placeholder="ENTER AD CONTENT"></textarea>
                    </div>
                    <div class="form-group">
...
<?php 
    if(isset($_POST['post']))
    {
        ...
        {// Start of if image file upload successful
            ...
            $adcontent=mysqli_real_escape_string($con,$_POST['adcontent']);

        $qry=mysqli_query($con,"SELECT * FROM advertisement WHERE shop_o_id='$sid' and add_title='$adtitle' and date(posted_on)=CURDATE()");
        $rows=mysqli_num_rows($qry);
        if($rows>0)
        {
            echo '<script>alert("Ad is already posted"); window.location="view_ad.php"; </script>';
        }
        else
        {
        $sql=mysqli_query($con,"INSERT INTO `advertisement`(`add_title`, `shop_o_id`, `add_desc`, `image`, `posted_on`, `add_status`) VALUES('$adtitle','$sid','$adcontent','$image',now(),'REQUESTED')") or die(mysqli_error($con));
                        if($sql)
                        {
                        ...
                        {
                           echo '<script>alert("Failed"); window.location="post_ad.php"; </script>'; 
                        }
        } 
    }
