                    ...
                    <?php 
                      $sql=mysqli_query($con,"SELECT * FROM advertisement order by posted_on desc");
                        ...
                        while($row=mysqli_fetch_array($sql))
                        {
                            ...
                            $qry=mysqli_query($con,"SELECT shop_name FROM shops, shop_owners where shops.shop_id=shop_owners.shop_id") ;
                            $col=mysqli_fetch_array($qry);
                      ?>
                        <h5>
                            <span class="post-color"><?php echo $row['posted_on']; ?></span> </h5>
                        <h4 class="post my-3"><?php echo $row['add_title']; ?></h4>
                        <p><?php echo $row['add_desc']; ?></p>

                    </div>
                    <div class="col-lg-6 galsses-grid-right">
                        <div class="galsses-grid-left">
                            <figure class="effect-lexi">
                                <img src="user/saved_images/<?php echo $row['image'];?>" alt="" class="img-fluid">
                                <figcaption>
                                    <h3><?php echo $col['shop_name']; ?>
                                    </h3>
                                    <p>Commercial Suite</p>
                                </figcaption>
                            </figure>
                        </div>
                    </div>
