    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-10 card" style="margin-bottom: 10px;margin-top: 10px;">
                ...
                <h3 class="title-5 m-b-20">Advertisement Information</h3>
                ...
                <table class="table table-bordered table-hover table-striped" style="margin-top: 20px;">
                    ...
                    <tbody>
                     <?php 
                      $sql=mysqli_query($con,"SELECT * FROM advertisement where shop_o_id='$sid' order by posted_on desc");
                      ...
                      ?>
                        ...
                        <tr class="tr-shadow">
                            ...
                            <td>
                                <img src="saved_images/<?php echo $row['image'];?>" style="height: 50px;width: 70px;" title="Advertisement Image">
                            </td>
                            ...
                            <td>
                                ...
                                {
                             ?>
                             <span style="color: orange; font-weight: bold; ">Yet to Check</span>
