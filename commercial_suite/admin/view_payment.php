...
<section id="main-content">
    <section class="wrapper">
        ...
        <div class="row">
                    ...
                    <div class="col-lg-2">
                               <a href="payment.php" class="btn btn-info" title="Add Payment Information"><i class="fa fa-eye"></i>Add Payment Info</a>
                           </div>
                </div>
                <br>
        <div class="row">
                           ...
                           Payment Information
                                    ...
                                    <table class="table table-bordered  table-hover" style="background-color:white" border="solid green 1px">
                                        ...
                                        <tbody>
                                         <?php 
                                          $i=1;
                                          $sql=mysqli_query($con,"SELECT * FROM payment,shop_owners,shops WHERE payment.shop_o_id=shop_owners.shop_o_id and shops.shop_id=shop_owners.shop_id  ORDER BY paid_date desc, shop_no asc");
