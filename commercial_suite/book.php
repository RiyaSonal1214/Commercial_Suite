                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control" name="bookby" required="" pattern="[A-Za-z\s]+" placeholder="ENTER BOKER NAME" >
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<?php 
    if(isset($_POST['post']))
    {
            ...
            $bookby=mysqli_real_escape_string($con,$_POST['bookby']);
           ...
           $qry=mysqli_query($con,"SELECT * FROM booking WHERE date(book_for)='$bookfor' and `time`='$time'") or die(mysqli_error($con));
            ...
            if($count <=0)
            {
                ...
                $hid=$fetch['hall_id']; 
                  ...
                  $sql=mysqli_query($con,"INSERT INTO `booking`( `hall_id`, `book_by`,`book_for`, `booked_on`, `time`, `book_comment`, `event`, `book_status`) VALUES ('$hid','$bookby','$bookfor',now(),'$time','$bookdesc','$event','booked')") or die(mysqli_error($con));
                            if($sql)
                            {
