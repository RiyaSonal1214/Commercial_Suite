...
<head>
    <title>Erection Real estate Category Bootstrap responsive Web Template | 404 :: w3layouts</title>
                    ...
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="404.php">Error</a>
    ...
    <section class="wthree-banner-bottom py-md-5 py-3">
        <div class="w3ls-inner-sec py-md-5 py-3">
            <div class="error-404">
                ...
                <div class="social_media footer-icons error-page my-4 text-center">
                    <ul>
                        <li>
